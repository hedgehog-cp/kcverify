...
jq -r '.[] | "{\(.api_id), \"\(.api_name)\"},"' ./assets/api_mst_ship/api_mst_ship.json         > ./include/constants/ship.hpp.inc      && touch ./include/constants/ship.hpp
jq -r '.[] | "{\(.api_id), \"\(.api_name)\"},"' ./assets/api_mst_slotitem/api_mst_slotitem.json > ./include/constants/equipment.hpp.inc && touch ./include/constants/equipment.hpp