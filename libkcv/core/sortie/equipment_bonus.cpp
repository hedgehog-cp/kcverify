...
auto kcv::sortie::get_equipment_bonus(
    ...
    const bool has_anti_air_radar = kcv::sortie::has_anti_air_radar(ship);
    const bool has_surface_radar  = kcv::sortie::has_surface_radar(ship);
    const bool has_accuracy_radar = kcv::sortie::has_accuracy_radar(ship);
...
bool matches_ship(const kcv::sortie::ship& ship, const kcv::kc3kai::bonus_data& data) {
...
bool matches_requires_id(const kcv::sortie::ship& ship, const kcv::kc3kai::bonus_data& data) {
    if (not data.requires_id.has_value()) {
        return true;
    }
...
bool matches_requires_type(const kcv::sortie::ship& ship, const kcv::kc3kai::bonus_data& data) {
    if (not data.requires_type.has_value()) {
        return true;
    }
