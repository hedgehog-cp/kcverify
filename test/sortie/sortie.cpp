...
int main() {
    const auto api_mst_ship = []() static -> kcv::kcsapi::api_mst_ship {
        ...
        kcv::read_json(temp, kcv::test::root / "test/sortie/api_mst_ship.json");
    ...
    const auto api_mst_slotitem = []() static -> kcv::kcsapi::api_mst_slotitem {
        ...
        kcv::read_json(temp, kcv::test::root / "test/sortie/api_mst_slotitem.json");
    ...
    auto data = std::filesystem::directory_iterator{kcv::test::root / "test/sortie/sortie_record"}
              ...
              | std::ranges::views::transform([&](const auto& sortie_record) {
                    return kcv::sortie::sortie_data::from_eoen(sortie_record, api_mst_ship, api_mst_slotitem);
                });
