...
int main() {
    const auto src = std::filesystem::path{"./assets/kcsapi/api_start2/api_mst_slotitem.json"};
    const auto dst = std::filesystem::path{"./library/include/kcv/core/constants/equipment.hpp.inc"};
