#ifndef KCVERIFY_KCSAPI_TYPES_ENUM_DAY_ATTACK_KIND_HPP_INCLUDED
#define KCVERIFY_KCSAPI_TYPES_ENUM_DAY_ATTACK_KIND_HPP_INCLUDED
...
#endif  // KCVERIFY_KCSAPI_TYPES_ENUM_DAY_ATTACK_KIND_HPP_INCLUDED
