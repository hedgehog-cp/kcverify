#ifndef KCVERIFY_KCSAPI_API_REQ_SORTIE_BATTLE_RESPONSE_HPP_INCLUDED
#define KCVERIFY_KCSAPI_API_REQ_SORTIE_BATTLE_RESPONSE_HPP_INCLUDED
...
// kcv
#include "kcsapi/types/api_air_base_attack.hpp"
#include "kcsapi/types/api_air_base_injection.hpp"
#include "kcsapi/types/api_flavor_info.hpp"
#include "kcsapi/types/api_friendly_battle.hpp"
#include "kcsapi/types/api_friendly_info.hpp"
#include "kcsapi/types/api_hougeki1.hpp"
#include "kcsapi/types/api_injection_kouku.hpp"
#include "kcsapi/types/api_kouku.hpp"
#include "kcsapi/types/api_opening_atack.hpp"
#include "kcsapi/types/api_raigeki.hpp"
#include "kcsapi/types/api_support_info.hpp"
#include "kcsapi/types/enum/detection_type.hpp"
#include "kcsapi/types/enum/engagement.hpp"
#include "kcsapi/types/enum/formation.hpp"
#include "kcsapi/types/enum/ship_id.hpp"
#include "kcsapi/types/enum/support_type.hpp"
...
struct response final {
    ...
    /// @brief 基地航空隊噴式強襲.
    std::optional<kcsapi::api_air_base_injection> api_air_base_injection;

    /// @brief 基地航空隊攻撃.
    std::optional<kcsapi::api_air_base_attack> api_air_base_attack;
    ...
    std::optional<kcsapi::api_friendly_info> api_friendly_info;

    /// @brief 友軍艦隊攻撃. 発動時のみ存在.
    std::optional<kcsapi::api_friendly_battle> api_friendly_battle;
    ...
    /// @brief 友軍艦隊航空攻撃.
    std::optional<kcsapi::api_kouku> api_friendly_kouku;

    /// @brief 敵ボス艦の情報とフレーバーテキスト. [1].
    std::optional<std::vector<kcsapi::api_flavor_info>> api_flavor_info;
    ...
    std::optional<kcsapi::api_support_info> api_support_info;
};
...
#endif  // KCVERIFY_KCSAPI_API_REQ_SORTIE_BATTLE_RESPONSE_HPP_INCLUDED
