#ifndef KCV_DOMAIN_VERIFICATION_ENTITY_AIR_BASE_HPP_INCLUDED
#define KCV_DOMAIN_VERIFICATION_ENTITY_AIR_BASE_HPP_INCLUDED
...
#endif  // KCV_DOMAIN_VERIFICATION_ENTITY_AIR_BASE_HPP_INCLUDED
