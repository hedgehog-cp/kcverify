#ifndef KCV_CORE_CONSTANTS_SHIP_ATTRIBUTES_HPP_INCLUDED
#define KCV_CORE_CONSTANTS_SHIP_ATTRIBUTES_HPP_INCLUDED
...
/// @brief 軽巡であるかを検証する.
bool is_cl(const kcv::kcsapi::api_mst_ship_value_t& mst) noexcept;

/// @brief 伊重巡であるかを検証する.
bool is_italian_ca(const kcv::kcsapi::api_mst_ship_value_t& mst) noexcept;
