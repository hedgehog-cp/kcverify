#ifndef KCV_EXTERNAL_EOEN_DATABASE_SORTIE_SORTIE_EQUIPMENT_HPP_INCLUDED
#define KCV_EXTERNAL_EOEN_DATABASE_SORTIE_SORTIE_EQUIPMENT_HPP_INCLUDED
...
#endif  // KCV_EXTERNAL_EOEN_DATABASE_SORTIE_SORTIE_EQUIPMENT_HPP_INCLUDED
