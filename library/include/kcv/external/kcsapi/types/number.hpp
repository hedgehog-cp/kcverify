#ifndef KCV_EXTERNAL_KCSAPI_TYPES_NUMBER_HPP_INCLUDED
#define KCV_EXTERNAL_KCSAPI_TYPES_NUMBER_HPP_INCLUDED
...
#endif  // KCV_EXTERNAL_KCSAPI_TYPES_NUMBER_HPP_INCLUDED
