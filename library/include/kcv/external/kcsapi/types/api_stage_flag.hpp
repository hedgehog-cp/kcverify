#ifndef KCV_EXTERNAL_KCSAPI_TYPES_API_STAGE_FLAG_HPP_INCLUDED
#define KCV_EXTERNAL_KCSAPI_TYPES_API_STAGE_FLAG_HPP_INCLUDED
...
#endif  // KCV_EXTERNAL_KCSAPI_TYPES_API_STAGE_FLAG_HPP_INCLUDED
