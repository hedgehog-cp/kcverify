#ifndef KCV_EXTERNAL_KCSAPI_TYPES_ENUM_LOST_KIND_HPP_INCLUDED
#define KCV_EXTERNAL_KCSAPI_TYPES_ENUM_LOST_KIND_HPP_INCLUDED
...
#endif  // KCV_EXTERNAL_KCSAPI_TYPES_ENUM_LOST_KIND_HPP_INCLUDED
