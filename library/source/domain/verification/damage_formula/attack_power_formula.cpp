...
auto mod::day(const kcv::context_data& ctx, const kcv::battlelog& data) -> kcv::functions::day {
    namespace impl = kcv::modifiers::day_impl;

    return std::visit(
        kcv::overloaded{
            [](const auto&) static noexcept -> kcv::functions::day { return kcv::functions::day{}; },
            [&ctx, &data](kcv::kcsapi::day_attack_kind v) -> kcv::functions::day {
                switch (v) {
                    ...
                    case kcv::kcsapi::day_attack_kind::special_kongo:
