...
void update(kcv::battlelogs_t& battlelogs, kcv::battlelog& current, const kcv::kcsapi::api_air_base_injection& data) {
...
void update(kcv::battlelogs_t& battlelogs, kcv::battlelog& current, const kcv::kcsapi::api_injection_kouku& data) {
    if (data.api_stage3.has_value()) {
