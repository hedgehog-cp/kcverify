#ifndef KCV_VERIFICATION_BATTLELOG_PROCESS_KCSAPI_HPP_INCLUDED
#define KCV_VERIFICATION_BATTLELOG_PROCESS_KCSAPI_HPP_INCLUDED
...
#endif  // KCV_VERIFICATION_BATTLELOG_PROCESS_KCSAPI_HPP_INCLUDED
