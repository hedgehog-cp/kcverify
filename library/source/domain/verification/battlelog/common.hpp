#ifndef KCV_VERIFICATION_BATTLELOG_COMMON_HPP_INCLUDED
#define KCV_VERIFICATION_BATTLELOG_COMMON_HPP_INCLUDED
...
#endif  // KCV_VERIFICATION_BATTLELOG_COMMON_HPP_INCLUDED
