#ifndef KCVERIFY_MODELS_KCSAPI_TYPES_API_DECK_DATA_HPP_INCLUDED
#define KCVERIFY_MODELS_KCSAPI_TYPES_API_DECK_DATA_HPP_INCLUDED
...
struct api_deck_data_value_t final {
    ...
    std::vector<std::int32_t> api_mission;
...
#endif  // KCVERIFY_MODELS_KCSAPI_TYPES_API_DECK_DATA_HPP_INCLUDED
