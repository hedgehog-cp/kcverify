#ifndef KCVERIFY_CORE_BATTLELOG_EQUIPMENT_HPP_INCLUDED
#define KCVERIFY_CORE_BATTLELOG_EQUIPMENT_HPP_INCLUDED
...
class equipment final {
   public:
    ...
    equipment(const kcv::kcsapi::api_mst_slotitem_value_t& mst, std::int32_t level, std::int32_t aircraft_level)
        : mst_{mst}
        , level_{level}
...
#endif  // KCVERIFY_CORE_BATTLELOG_EQUIPMENT_HPP_INCLUDED
