...
/// @brief 関数を合成する.
template <kcv::composable F1, kcv::composable F2>
constexpr auto operator|(const F1& f1, const F2& f2) {
    return function_composition<F1, F2>{f1, f2};
}

/// @brief 関数を合成する.
template <kcv::composable... Fs1, kcv::composable... Fs2>
...
/// @brief 関数を合成する.
template <kcv::composable... Fs1, kcv::composable F2>
...
/// @brief 関数を合成する.
template <kcv::composable F, kcv::composable... Fs2>
