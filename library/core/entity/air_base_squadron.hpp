#ifndef KCVERIFY_CORE_ENTITY_AIR_BASE_SQUADRON_HPP_INCLUDED
#define KCVERIFY_CORE_ENTITY_AIR_BASE_SQUADRON_HPP_INCLUDED
...
#endif  // KCVERIFY_CORE_ENTITY_AIR_BASE_SQUADRON_HPP_INCLUDED
